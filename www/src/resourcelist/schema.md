...
<h4>Semantics</h4>
<p class="termsemantics">Having this property implies being genid28. Every value of this property is a <a href="http://www.w3.org/2001/XMLSchema#date" class="uri">xsd:date</a>. </p>
<h4 id="sec-status">Status</h4>
...
<h4>Semantics</h4>
<p class="termsemantics">Having this property implies being genid32. Every value of this property is a <a href="http://www.w3.org/2001/XMLSchema#date" class="uri">xsd:date</a>. </p>
<h4 id="sec-status">Status</h4>
...
<h4>Semantics</h4>
<p class="termsemantics">Having this property implies being a <a href="http://purl.org/vocab/resourcelist/schema#List" class="uri">Resource List</a>. Every value of this property is genid11. </p>
<h4 id="sec-status">Status</h4>
<ul><li>2008-05-19 - first issued</li></ul>
<h3 id="list">List</h3>
...
<h4>Semantics</h4>
<p class="termsemantics">Having this property implies being genid8. Every value of this property is a <a href="http://purl.org/vocab/resourcelist/schema#List" class="uri">Resource List</a>. </p>
<h4 id="sec-status">Status</h4>
<ul><li>2008-05-19 - first issued</li></ul>
<h3 id="next">Next</h3>
...
<h4>Semantics</h4>
<p class="termsemantics">Having this property implies being genid17. Every value of this property is genid14. </p>
<h4 id="sec-status">Status</h4>
...
<h4>Semantics</h4>
<p class="termsemantics">Having this property implies being genid24. Every value of this property is genid21. </p>
<h4 id="sec-status">Status</h4>
<ul><li>2008-05-19 - first issued</li><li>2009-07-01 - semantic change by Nadeem Shabir: Deprecated: Lists and Sections are now subclasses of rdf:Seq, explicit ordering using previous/next is highly undesirable</li></ul>
